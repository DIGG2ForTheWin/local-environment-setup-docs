...
For the terms GPT, ext4, label, UUID and `nofail`, see [Ubuntu and storage](../domibus/05-storage.md#terms-used-on-this-page). The commands follow the same pattern as the gateways, with label `sdk-core-data`.
