# DomiSMP failures, mistakes and fixes
...
A long descriptive snapshot name was initially suggested, but the established convention used numbered short milestone names (`00-...`, `01-...`). The correct new checkpoint was chosen as:

```text
02-domismp-installed
```

This naming rule should continue for future snapshots.
