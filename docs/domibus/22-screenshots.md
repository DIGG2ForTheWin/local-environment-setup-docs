...
The sdk-core / DomiSMP screenshots are on [sdk-core screenshot evidence](../sdk-core/17-screenshots.md).
...
*Two Domibus JVMs running at the same time (PIDs 3442 and 5008), with 8080 owned by 5008. This is the stale-process problem in [failure 3](15-failures-and-fixes.md#3-stale-java-process).*
