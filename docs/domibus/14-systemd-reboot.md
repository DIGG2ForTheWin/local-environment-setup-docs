...
- **`WorkingDirectory=/opt/domibus`**: avoids the FreeMarker working-directory problem ([failure 2](15-failures-and-fixes.md#2-blue-first-start-working-directory-freemarker-warning)).
